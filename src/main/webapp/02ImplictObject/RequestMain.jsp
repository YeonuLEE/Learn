...
<a href="./RequestWebInfo.jsp?eng=bye&kor&math=90&sci=100=잘가">Get방식 전송</a> <br>

<form action="RequestWebInfo.jsp" method="post">
영 어: <input type= "text" name="eng" value="Hello"/><br/>
한 글: <input type= "text" name="kor" value="안녕"/><br/>
